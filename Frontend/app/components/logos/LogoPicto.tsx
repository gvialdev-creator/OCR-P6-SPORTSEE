export function LogoPicto() {
  return (
    <svg width="19" height="21" viewBox="0 0 19 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="4.00003" y="5.65625" width="3" height="15" rx="1.5" fill="url(#paint0_linear_9_86)"/>
        <rect x="7.00003" y="14" width="3" height="14" rx="1.5" transform="rotate(180 7.00003 14)" fill="url(#paint1_linear_9_86)"/>
        <rect x="16" y="11.3281" width="3" height="6" rx="1.5" fill="url(#paint2_linear_9_86)"/>
        <rect x="19" y="14" width="3" height="14" rx="1.5" transform="rotate(180 19 14)" fill="url(#paint3_linear_9_86)"/>
        <rect x="12" y="11" width="3" height="9" rx="1.5" fill="url(#paint4_linear_9_86)"/>
        <rect x="15" y="14" width="3" height="9" rx="1.5" transform="rotate(180 15 14)" fill="url(#paint5_linear_9_86)"/>
        <rect x="8.00003" y="11.3281" width="3" height="5" rx="1.5" fill="url(#paint6_linear_9_86)"/>
        <rect x="11" y="14" width="3" height="12" rx="1.5" transform="rotate(180 11 14)" fill="url(#paint7_linear_9_86)"/>
